...
<html>
  ...
  <div id="add_body">
    ...
    <struts:form action="driver" method="post" theme="simple">	
    	...
    	<label>性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</label>
    	<struts:radio name="driver.gender" label="性别" list="#{'1':'男','0':'女'} " value="1"/>
        <p>
    	<label>出生日期：</label>
        ...
        <p>
    	<label>身份证号：</label>
    	<struts:textfield name="driver.iden" cssClass="texbox"/>
        </p>
        <p>
    	<label>驾照类型：</label>
        ...
        <p>
        <label>电话号码：</label>
        <struts:textfield name="driver.phone" cssClass="texbox"/>
        </p>
         <p>
    	<label>入职日期：</label>
        ...
        <p>
        <label>状&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;态：</label>
        <struts:radio name="driver.mode" list="#{'0':'已出车','1':'待出车','2':'离岗'} " value="1"/>
        </p>
